...
export class ALTERUSERPOSTADDCOLUSERID1732375549780 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."posts" ALTER COLUMN "userId" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."posts" ALTER COLUMN "userId" DROP NOT NULL`);
