...
export class USERPOSTRELATEDTABLES31732298437685 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."comments" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."comments" DROP COLUMN "updatedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."comments" ADD "userId" uuid`,
    );
    await queryRunner.query(
