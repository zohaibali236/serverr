...
export class USERPOSTRELATEDTABLES71732300686718 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" DROP COLUMN "userId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" ADD "userIdId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" ADD "postIdId" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" ADD CONSTRAINT "FK_b9a5ae564d1538e1272ddb115a3" FOREIGN KEY ("userIdId") REFERENCES "sport_Eaze"."Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" ADD CONSTRAINT "FK_2d994af52e4a2157d7cdfccfcb5" FOREIGN KEY ("postIdId") REFERENCES "sport_Eaze"."posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" DROP CONSTRAINT "FK_2d994af52e4a2157d7cdfccfcb5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" DROP CONSTRAINT "FK_b9a5ae564d1538e1272ddb115a3"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" DROP COLUMN "postIdId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" DROP COLUMN "userIdId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."comments" ADD "postId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" ADD "PostId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "sport_Eaze"."Postlikes" ADD "userId" uuid`,
    );
    await queryRunner.query(
