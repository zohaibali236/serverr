...
export class CREATESPORTS1731955954541 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sport_Eaze"."Sports" ("id" SERIAL NOT NULL, "name" character varying(25) NOT NULL, CONSTRAINT "UQ_943769ff5b2ecd52ae3dab49aab" UNIQUE ("name"), CONSTRAINT "PK_b21fe37bae098517da43542fec5" PRIMARY KEY ("id"))`);
