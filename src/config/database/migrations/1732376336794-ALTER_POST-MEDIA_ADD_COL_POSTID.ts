...
export class ALTERPOSTMEDIAADDCOLPOSTID1732376336794 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."PostMedia" ALTER COLUMN "postId" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."PostMedia" ALTER COLUMN "postId" DROP NOT NULL`);
