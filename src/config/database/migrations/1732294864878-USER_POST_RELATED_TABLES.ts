...
export class USERPOSTRELATEDTABLES1732294864878 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "sport_Eaze"."Postlikes_reacttype_enum" AS ENUM('Like', 'Heart', 'Laugh', 'Sad', 'Wow')`);
        ...
        await queryRunner.query(`CREATE TABLE "sport_Eaze"."comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "sport_Eaze"."PostMedia_mediatype_enum" AS ENUM('Image', 'Video')`);
        await queryRunner.query(`CREATE TABLE "sport_Eaze"."PostMedia" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mediaType" "sport_Eaze"."PostMedia_mediatype_enum" NOT NULL, "mediaOrder" integer NOT NULL, "postId" uuid, CONSTRAINT "PK_09a711528b07c186c8853981495" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "sport_Eaze"."posts_visibility_enum" AS ENUM('Public', 'Private', 'FollowersOnly')`);
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."Postlikes" ADD CONSTRAINT "FK_3dcdc000fa3de61bee4538e546a" FOREIGN KEY ("id") REFERENCES "sport_Eaze"."posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."posts" ADD CONSTRAINT "FK_2829ac61eff60fcec60d7274b9e" FOREIGN KEY ("id") REFERENCES "sport_Eaze"."Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."shared_posts" ADD CONSTRAINT "FK_5dfa2e0e663fb75b9c3ad824e20" FOREIGN KEY ("originalPostId") REFERENCES "sport_Eaze"."posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."shared_posts" DROP CONSTRAINT "FK_5dfa2e0e663fb75b9c3ad824e20"`);
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."posts" DROP CONSTRAINT "FK_2829ac61eff60fcec60d7274b9e"`);
        ...
        await queryRunner.query(`ALTER TABLE "sport_Eaze"."Postlikes" DROP CONSTRAINT "FK_3dcdc000fa3de61bee4538e546a"`);
